...
import at.ac.fhcampuswien.fhmdb.patterns.builderPattern.MovieAPIURLbuilder;
import okhttp3.*;
...
public class MovieAPI {
    ...
    public static List<Movie> getAllMovies(String query, Genre genre, String releaseYear, String ratingFrom) throws MovieApiException{
        String url;
        MovieAPIURLbuilder movieAPIURLbuilder = new MovieAPIURLbuilder()
                .baseUrl(URL)
                .query(query)
                .genre(genre)
